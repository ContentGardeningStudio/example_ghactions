# example_ghactions contributing guidelines

The example_ghactions community appreciates your contributions via issues and
pull requests.  Note that the [code of conduct](CODE_OF_CONDUCT.md)
applies to all interactions with the example_ghactions project, including
